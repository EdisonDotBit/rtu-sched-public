...
function FormDetails() {
    return (
        <div className="flex flex-col justify-center w-3/4">
            ...
            <label
                htmlFor="text"
                className="relative block overflow-hidden mb-4 rounded-md border border-gray-200 px-3 pt-3 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600 w-1/3"
            >
                <input
                    type="number"
