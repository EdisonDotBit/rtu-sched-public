    ...
    return (
        <div className="flex flex-col w-full">
            <div className="w-full">
                ...
                <div className="bg-white rounded-lg border border-gray-100 shadow-sm mb-4 overflow-hidden">
                    <dl className="divide-y divide-gray-100 text-sm">
                        {/* Personal Information Header */}
                        <div className="grid grid-cols-1 p-2 sm:p-3 bg-[#194F90] text-white">
                        ...
                        <div className="grid grid-cols-1 p-2 sm:p-3 sm:grid-cols-3 sm:gap-4">
