    ...
    <>
      ...
      <div className="flow-root rounded-lg border border-gray-100 py-3 shadow-sm mb-4">
                    ...
                    <div className="flex justify-evenly">
                      <button className=" w-[200px] border-solid border-[1px] border-black p-[10px] text-black bg-[#FF0000]">Delete</button>
                      <button className=" w-[200px] border-solid border-[1px] border-black p-[10px] text-black">Resend Appointment</button>
                      <button className=" w-[200px] border-solid border-[1px] border-black p-[10px] text-black bg-[#0038FF]">Reschedule</button>
                    </div>
    </>
