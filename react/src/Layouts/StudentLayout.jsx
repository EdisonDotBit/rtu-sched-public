        ...
        <div className="flex flex-col h-screen overflow-hidden font-roboto">
            ...
            <header className="flex items-center justify-between bg-[#FFDB75] px-4 sm:px-6 py-2 h-14 sm:h-16">
                ...
                <div className="relative" ref={dropdownRef}>
                    <button
                        className="flex items-center gap-1 sm:gap-2 text-sm text-gray-700 hover:text-[#123A69] focus:outline-none"
                    ...
                    {isDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-40 sm:w-48 bg-white border border-gray-200 rounded-md shadow-lg z-50">
                            <NavLink
                                ...
                                className="block px-3 sm:px-4 py-2 text-sm text-gray-800 hover:bg-gray-100"
                                onClick={() => setIsDropdownOpen(false)}
                            >
                                Manage Account
                            </NavLink>
                            <button
                                className="block w-full text-left px-3 sm:px-4 py-2 text-sm text-gray-800 hover:bg-gray-100"
                ...
                >
                    <div className="flex items-center justify-between h-16 sm:h-20 bg-[#194F90] text-white px-4 sm:px-6 py-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-sm sm:text-base text-white font-bold uppercase px-2 truncate">
