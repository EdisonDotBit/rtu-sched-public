        ...
        <div className="font-poppins flex flex-col h-screen overflow-hidden w-full bg-gray-50">
            ...
            <header className="flex items-center justify-between bg-[#FFDB75] px-4 sm:px-6 py-2 h-14 sm:h-16 shadow-sm">
                ...
                <NavLink to="../student/login">
                    <button className="cursor-pointer text-sm text-gray-500 hover:text-[#123A69] px-3 py-1.5 rounded hover:bg-[#FFDB75]/50 transition-colors font-medium">
                        Sign in as Student
                    </button>
                </NavLink>
            </header>
